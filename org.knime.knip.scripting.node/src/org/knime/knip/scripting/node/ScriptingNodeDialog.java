...
public class ScriptingNodeDialog extends NodeDialogPane {
	...
	private List<DialogComponent> m_generatedDialogComponents = Collections.emptyList();
	...
	protected void saveSettingsTo(final NodeSettingsWO settings)
		...
		for (DialogComponent dialogComponent : m_generatedDialogComponents) {
	...
	private void createAutogenPanel() {
		...
		m_generatedDialogComponents = new ArrayList<>(inputPanel.createDialogComponents());
	}
