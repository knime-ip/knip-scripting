...
public class SciJavaScriptingCodeEditor implements Contextual {
    ...
    private final JComboBox<String> m_langSelection =
            new JComboBox<>(new String[] { "Java" });
    ...
    private void buildDialog() {
        ...
        final GridBagConstraints gbc_lbl_header =
                createGBC(0, 0, 1, 1, WEST, FILL_NONE, new Insets(0, 3, 0, 0));
        final GridBagConstraints gbc_lbl_lang =
                createGBC(2, 0, 1, 1, EAST, FILL_NONE, new Insets(0, 0, 0, 3));
        final GridBagConstraints gbc_ls =
                createGBC(3, 0, 2, 1, EAST, FILL_HORI, new Insets(3, 3, 3, 3));
