...
public class Util {
	 ...
	 * The mappings are stored as Strings in the format "columnName\ninputName".
	 * 
	...
	/**
	 * Add contents of a {@link SettingsModelStringArray} to a {@link ColumnToModuleItemMappingService}.
	 * @param model model to get the contents from
	 * @param service service to add the contents of model to
	 * @return true on success, false if model contained a String not in the format "columnName\ninputName".
	 */
	public static boolean fillColumnToModuleItemMappingService(SettingsModelStringArray model, ColumnToModuleItemMappingService service) {
